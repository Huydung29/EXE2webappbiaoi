...
export default function GuideDetail() {
  ...
  const stats = useMemo(() => {
    ...
    if (guide.difficulty)
      items.push({ icon: "🎯", label: `Độ khó: ${guide.difficulty}` });
  ...
  return (
    <div className="guide-detail-page style="margin-left: 179px">
      {!guide ? (
        <div className="container py-5">
          <div className="alert alert-warning">
            Không tìm thấy hướng dẫn.
            <div className="mt-2">
              <Link to="/huong-dan" className="btn btn-primary btn-sm">
        ...
        <>
          ...
          <div className="bg-gradient position-relative text-white">
            ...
            >
              ...
              {guide.subtitle && (
                <p className="lead opacity-75 mb-0">{guide.subtitle}</p>
              )}
              ...
              <div className="d-flex flex-wrap align-items-center gap-2 mt-3">
                {stats.map((s, i) => (
                  <span
                    key={i}
                    className="badge rounded-pill bg-opacity-25 bg-white text-white px-3 py-2 border border-light"
                  >
                ...
                {tags.map((t, i) => (
                  <span
                    key={`tag-${i}`}
                    className="badge rounded-pill bg-opacity-25 bg-black border border-light-subtle text-white px-3 py-2"
                  >
                    #{t}
                  </span>
                ))}
          ...
          <div className="container py-4 py-lg-5">
                ...
                <div className="card border-0 shadow-sm mb-4">
                  <div className="card-body">
                    ...
                    {stats.length > 0 && (
                      <div className="d-flex flex-wrap gap-2 mb-3">
                        {stats.map((s, i) => (
                          <span
                            key={i}
                            className="badge rounded-pill bg-body-tertiary text-secondary border px-3 py-2"
                          >
                            <span className="me-1">{s.icon}</span>
                            {s.label}
                          </span>
                    ...
                    <div className="d-grid gap-2 mb-3">
                      {guide.buyLink && (
                        <a href={guide.buyLink} className="btn btn-primary">
                          Mua bộ DIY
                        </a>
                      )}
                    </div>
                    ...
                    {guide.steps?.map((s, i) => (
                      <div key={i} className="timeline-item">
                        ...
                        <div className="timeline-content">
                          ...
                          <p className="mb-3">
                            {isObjectStep(s) ? s.desc : String(s)}
                          </p>
            ...
            <div className="text-center mt-4">
              <Link to="/huong-dan" className="btn btn-outline-primary btn-sm">
          ...
          <div
            ...
            tabIndex="-1"
            aria-hidden="true"
            style={{ display: zoomImg ? "block" : "none" }}
          >
            <div className="modal-dialog modal-dialog-centered modal-xl">
              <div className="modal-content">
                ...
                <div className="modal-body">
                  {zoomImg && (
                    <img src={zoomImg} alt="zoom" className="img-fluid w-100" />
                  )}
                </div>
              </div>
            </div>
